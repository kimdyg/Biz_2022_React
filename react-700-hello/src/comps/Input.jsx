...
const Input = ({ aName, setAName }) => {
  ...
  // state 변수는 값을 절대 직접 저장하지 않는다
  // aName = "홍길동" --- 이런 코드는 절대 사용금지
  // setAName("이몽룡") --- state 변수에 값을 변경하는 방법
  ...
  /* 
    ...
    Main 컴포넌트의 h3 컴포넌트에 즉시 보이게 하고 싶다
  ...
  */
  ...
  // 키보드를 사용하여 text를 입력하면 입력한 text가
  // e.target.value 에 담겨서 onChangeEvent 함수에 전달된다
  ...
  // state 변수를 직접 핸들링 할 수 없도록 하는 조치이다
