...
JS class 를 사용하면 기존의 JS 코드의 장점이 많이 활용하기가 다소 어렵다
JS class 는 Java 클래스에 비하면 class 를 만드는데 상당히 복잡한 코드들이 필요하다
class 에 method 를 추가하거나, 어떤 변수를 선언할 떄는 상당히 어려움이 있다
...
이 부분을 고민하던 React 개발자(페이스북 개발자들이)들이
...
useContext() : ContextProvider의 Store 에 저장된 변수, 함수를
  가져오는 Hook 함수
*/
...
항상 명시해 줘야 한다.
함수를 사용할 때 반드시 무엇인가를 명시해주는 것은 코딩을 하는 입장에서
다소 불편할 수 있다.
...
const AppContextProvider = ({ children }) => {
  ...
  // Store 에 보관할때 개별적인 요소들로 보낼 수 있지만
